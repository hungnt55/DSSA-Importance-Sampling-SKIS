Instructions to run D-SSA + SKIS (Importance Sketching) for Influence Maximization
...
Terms of use:
--------------------------------------------------------
The D-SSA+SKIS software is released under the MIT license with the details listed in the LICENSE file.
